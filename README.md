# AI for Flamingo — Design System AI Strategy
...
The page includes a theme toggle button located in the bottom-right corner (next to the main navigation).

**How to use:**
- Click the **🌙 Moon icon** (dark mode) or **☀️ Sun icon** (light mode) to switch themes
- Hover over the toggle to see the action ("Switch to Light Mode" or "Switch to Dark Mode")
- Your preference is saved automatically in local storage and persists across sessions

**Theme Features:**
- **Dark Mode**: Rich, deep colors optimized for reduced eye strain
- **Light Mode**: Clean, bright interface with adjusted colors for readability
